...
;                              OR (you don't have Bombchus and not BOMBCHUS_IN_LOGIC)
;                              OR max Bombchu ammo
; modifies t6
; returns value in a1 (0 to allow purchase, textID otherwise)

    lb      t6, BOMBCHUS_IN_LOGIC
    bne     t6, r0, @@check_rupees ; allow purchase if BOMBCHUS_IN_LOGIC
    lui     t6, hi(SAVE_CONTEXT + 0xA3)
    lb      a1, lo(SAVE_CONTEXT + 0xA3)(t6) ; bombbag size
    andi    a1, a1, 0x38
    bnez    a1, @@check_rupees ; allow if Bomb bag in equipment
