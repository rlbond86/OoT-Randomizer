...
item_row_t item_table[] = {
    ...
    [0x33] = ITEM_ROW(0x53, 0, 0x4E, 0x0059, 0x00BF, 0x19, no_upgrade, give_bomb_bag, -1, -1), // Big Bomb Bag
    [0x34] = ITEM_ROW(0x53, 0, 0x4F, 0x005A, 0x00BF, 0x1A, no_upgrade, give_bomb_bag, -1, -1), // Biggest Bomb Bag
